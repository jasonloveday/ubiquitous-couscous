	...
	prty = { 
        ...
        buildThumb: function() { 
            ...
            for(var i=0; i < prty.photoDetails.length; i++){
                ...
                thisItem = prty.galleryDiv.append("<li id="+i+"><a href='"+img.url_o+"'><img src='"+img.url_m+"' alt='"+img.title+"' /><div class='bg'></div><div class='content'></div><i class='show' data-href='"+img.url_o+"' data-photoid='"+img.id+"'>Show</i></a></li>").find('li .content').last();
